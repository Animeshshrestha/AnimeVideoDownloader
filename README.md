This project for now only scrapes the episode from the anime name you have entered  To run the scrapy go to inside gogoanime directory and run command scrapy crawl:  
